...
Implement a Convolutional Neural Network (CNN) model to classify the CIFAR-10 dataset.
...
4. Randomly choose 10 images from testing data and use model to predict their class.